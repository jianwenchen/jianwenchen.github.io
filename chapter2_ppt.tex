...
\begin{frame}
 ...
 \begin{frame}
  ...
  \begin{proof}[证明]\justifying\let\raggedright\justifying
    ...
    \pause以下证明$|A|=|B|$。\pause构造映射$f:A\to B$，\pause对任意的$\sigma\in A$，\pause$f(\sigma) = \sigma(12)$。\pause易验证$f$为单射，\pause这是因为对任意的$\sigma_1\in A$，\pause$\sigma_2\in A$，\pause如果$f(\sigma_1)=f(\sigma_2)$，\pause则$\sigma_1(12)=\sigma_2(12)$，\pause从而$\sigma_1(12)(12)=\sigma_2(12)(12)$，\pause即$\sigma_1=\sigma_2$。\pause同时，\pause易验证$f$为满射，\pause这是因为对任意的$\tau \in B$，\pause$f(\tau(12))=\tau(12)(12)=\tau$。\pause从而$f$为双射，\pause这证明了$|A|=|B|$。\pause再由$|A|+|B|=n!$知，\pause$|A|=|B|=\frac{n!}{2}$。
  \end{proof}  
 \end{frame}
\section{代数运算}
\begin{frame}
