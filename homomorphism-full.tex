...
$f$为单射，这是因为$\forall g_1K,g_2K\in G_1/K$，如果$f(g_1K)=f(g_2K)$，则$\phi(g_1)=\phi(g_2)$，从而$\phi(g_1)^{-1}*\phi(g_2)=e_2$，即$\phi(g_1^{-1})*\phi(g_2)=e_2$，因此$\phi(g_1^{-1}\circ g_2)=e_2$，于是$g_1^{-1}\circ g_2\in K$，所以$g_1K=g_2K$。
