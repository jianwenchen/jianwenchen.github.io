...
\begin{proof}[证明]
  ...
  $\Rightarrow$
  设$a^{-1}b\in H$，则$\forall g\in aH$，$\exists h\in H$，使得$g=ah=b((b^{-1}a)h)=b((a^{-1}b)^{-1}h)\in bH$，从而$aH\subseteq bH$；
  由$a^{-1}b\in H$可得$b^{-1}a\in H$，从而$bH\subseteq aH$。
\end{proof}
\begin{Thm}
...
\end{Thm}
\begin{proof}[证明]
  $H$在$G$中的所有不同的左陪集构成的集族为$G$的一个划分，每个左陪集均含有$n$个元素。因此，$|G|=n|G:H|$。
\end{proof}
\begin{Cor}
